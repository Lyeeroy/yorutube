import { Component, ChangeDetectionStrategy, input, computed, output, inject, signal, effect, HostListener, ElementRef } from '@angular/core';
...
export class VideoCardComponent {
  ...
  videoInfoLine = computed(() => {
    ...
    const date = isMovie(currentMedia) ? currentMedia.release_date : currentMedia.first_air_date;
